...
export default function CMVAnalysisPage() {
  ...
  const filteredProducts = useMemo(() => {
    return products.filter(p => {
      ...
      const matchesStatus = showInactive ? true : p.is_available;
                        ...
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              ...
                              {!product.is_available && <span className="text-[10px] bg-red-50 text-red-500 px-2 py-0.5 rounded-full font-bold uppercase tracking-wide">Inativo</span>}
                            </div>
                          </div>
                        </td>
                        <td className="px-6 py-4">
